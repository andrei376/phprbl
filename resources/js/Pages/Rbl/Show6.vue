                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <inertia-link class="badge badge-secondary mr-2" :href="this.route('rbl.toggle6', {'id': ipInfo.id, 'list': list, 'field': 'delete'})">{{ this.__('Change') }}</inertia-link>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <inertia-link class="badge badge-secondary mr-2" :href="this.route('rbl.toggle6', {'id': ipInfo.id, 'list': list, 'field': 'active'})">{{ this.__('Change') }}</inertia-link>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <inertia-link class="badge badge-secondary mr-2" :href="this.route('rbl.toggle6', {'id': ipInfo.id, 'list': list, 'field': 'checked'})">{{ this.__('Change') }}</inertia-link>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
