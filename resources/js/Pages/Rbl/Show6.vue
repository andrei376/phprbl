            ...
            <div class="col-12">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                            ...
                            <table class="table table-striped table-bordered table-sm">
                                <tbody>
                                    <tr class="">
                                        ...
                                        <td class="col-11">{{ ipInfo.mask }} ({{ this.__("total hosts") }} = 2^(128-{{ ipInfo.mask }})=
                                            <span class="font-weight-bolder">{{ Intl.NumberFormat('ro-RO').format(Math.pow(2, (128 - ipInfo.mask))) }}</span>)
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <inertia-link class="badge btn btn-secondary mr-2" :href="this.route('rbl.toggle6', {'id': ipInfo.id, 'list': list, 'field': 'delete'})">{{ this.__('Change') }}</inertia-link>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <inertia-link class="badge btn btn-secondary mr-2" :href="this.route('rbl.toggle6', {'id': ipInfo.id, 'list': list, 'field': 'active'})">{{ this.__('Change') }}</inertia-link>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <inertia-link class="badge btn btn-secondary mr-2" :href="this.route('rbl.toggle6', {'id': ipInfo.id, 'list': list, 'field': 'checked'})">{{ this.__('Change') }}</inertia-link>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div id="9showLogsIp">
                            <log-hits :list="list" :id="ipInfo.id" :search-ip="ipInfo.long2ip" />
                        </div>

                        <div id="11elastic">
                            <elastic :iplong="ipInfo.long2ip" :mask="ipInfo.mask" />
                        </div>

<!--                        <div id="10syslog">
                            <syslog :iplong="ipInfo.long2ip" :mask="ipInfo.mask" />
                        </div>-->
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        forceWhois() {
            ...
            let url = this.route('update.show6', {
                id: this.ipInfo.id,
                list: this.list,
                forceWhois: true
            });
        ...
        updateIp() {
            ...
            axios.post(url, { 'newIp': this.whoisData.range }).then(function () {
                window.location = this.route('rbl.show6', {
                    id: this.ipInfo.id,
                    list: this.list
                });
